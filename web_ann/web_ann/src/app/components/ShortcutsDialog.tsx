...
export function ShortcutsDialog({ open, onOpenChange }: ShortcutsDialogProps) {
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="bg-gray-900 border-gray-700 text-slate-300 max-w-md">
        <DialogHeader>
        ...
        <div className="space-y-3 mt-4">
          {shortcuts.map((shortcut, index) => (
            ...
            >
              ...
              <kbd className="px-3 py-1.5 bg-gray-800 border border-gray-600 rounded text-sm font-mono text-slate-300">
                {shortcut.key}
              </kbd>
            </div>
          ))}
